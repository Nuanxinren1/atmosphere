    ...
    function (declare, tiled, TiledMapServiceLayer, SpatialReference, Extent, TileInfo) {
        return declare([TiledMapServiceLayer], {
            ...
            getTileUrl: function (level, row, col) {
                ...
                tileUrl = this._url + "?tk=f9ccb94730c9b51cb2986a98d897b297&SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER="+this.noteType.substr(0,3)+"&STYLE=default&TILEMATRIXSET="+this.noteType.substr(4,1)+"&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=tiles";
